...
export default function AddressList() {
    ...
    const remove = async (data) => {
        try {
            const res = await departmentService.delete(data);
    ...
    const fetchAll = async () => {
        try {
            const res = await departmentService.getGetDepartments(gridSearch);
            console.log(res);
            dispatch({
                type: RETRIEVE_DATA,
    ...
    return (
        <div >
            ...
            <Stack gap={1} style={{ margin: '0px' }}>
                <div className="p-2">
                    <h4 className="liner">Department-Mananagement</h4>
                </div>
                <div className="p-2">
